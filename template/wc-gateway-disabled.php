...
<div class="notice notice-info" style="padding: 10px;">
	<div style="display: flex; gap:20px; align-items:center;">
		...
		<div>
			<span style="font-weight: 700;"><?php esc_html_e( 'POS Entegratör not active', 'gurmepos' ); ?></span>
			<p><?php esc_html_e( 'In order to use the POS Entegrator, you must first activate it from WooCommerce > Settings > Payments.', 'gurmepos' ); ?> </p>
