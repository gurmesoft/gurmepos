...
$gpos_texts = array(
	'default' => array(
		...
		'card_save' 						=> __( 'Card Save','gurmepos' ),
		'documents' 						=> __( 'Documents','gurmepos' ),
		'other' 							=> __( 'Other','gurmepos' ),
		'activate' 							=> __( 'Activate','gurmepos' ),
		'saved_card_active'					=> __( 'With the Card Save feature, they can save their cards during payment.','gurmepos' ),
		...
		'form_texts' 						=> __( 'Form Texts', 'gurmepos' ),
